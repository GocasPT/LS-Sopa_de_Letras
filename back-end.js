let TodasAsPalavras = ['BMW','Mercedes','Audi','Fiat','Jaguar','Seat','Citroen','Porshe','Prozis','Monster','Redbull','Zara','McDonalds','Samsung','Apple','Microsoft','Lotus','Amazon','Razer','HP','SportZone','Decathlon','Coca-Cola','Disney','Google','Nike','Addidas','Meta','Instagram','Facebook','Honda','IKEA','Nescafe','Gucci','Prada','Sony','Huawei','Nestle','Ebay','Rolex','Nintendo','PlayStation','Burger-King','Lego','Gomas','Banana','Chocolate','Pera','Limão','Arroz','Massa','Croquete','Batatas','Rissol','Sumol','Água','Kiwi','Ketchup']
let Marcas = ['BMW','Mercedes','Audi','Fiat','Jaguar','Seat','Citroen','Porshe','Prozis','Monster','Redbull','Zara','McDonalds','Samsung','Apple','Microsoft','Lotus','Amazon','Razer','HP','SportZone','Decathlon','Coca-Cola','Disney','Google','Nike','Addidas','Meta','Instagram','Facebook','Honda','IKEA','Nescafe','Gucci','Prada','Sony','Huawei','Nestle','Ebay','Rolex','Nintendo','PlayStation','Burger-King','Lego']
let Comidas = ['Gomas','Banana','Chocolate','Pera','Limão','Arroz','Massa','Croquete','Batatas','Rissol','Sumol','Água','Kiwi','Ketchup']
...
function PosicionarPalavra() {
    ...
    if (PalavraEncontrada == '') { // Se a palavra foi removida
        return 0;
    }
    ...
    if (Direcao > 15) { // Direita
        ...
        ReturnarPreenchido = DefinirPalavra(GerarPosicaoX, GerarPosicaoY, PalavraEncontrada);

    } else if (Direcao > 12) { // Esquerda
        ...
        ReturnarPreenchido = DefinirPalavra(VerificaDistancaDireita, GerarPosicaoY, PalavraEncontrada); // Aqui enviamos o X como a posição de verificação para facilitar o inject da palavra ao inves de fazermos o algoritmo inverso :)

    } else if (Direcao > 9) { // Diagonal Baixo
        ...
        if (VerificaDistancaDiagonaBaixoX<1 || VerificaDistancaDiagonaBaixoY < 1){
            return 0; // Cancelar Palavra Inválida
        }

        ReturnarPreenchido = DefinirPalavra(GerarPosicaoX, GerarPosicaoY, PalavraEncontrada);

    } else if (Direcao > 6) { // Diagonal Cima
        ...
        if (VerificaDistancaDiagonaCimaoX > Config.Distancia || VerificaDistancaDiagonaCimaY > Config.Distancia){
            return 0; // Cancelar Palavra Inválida
        }
